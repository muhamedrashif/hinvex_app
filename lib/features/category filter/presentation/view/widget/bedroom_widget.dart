    ...
    return Row(children: [
      GestureDetector(
                  ...
                  child: Container(
                    ...
                    margin: const EdgeInsets.only(right: 10,bottom: 10,top: 10),
                    decoration: BoxDecoration(
                      color:value==4? AppColors.blueColor:AppColors.backgroundColor,
                      borderRadius: BorderRadius.circular(10),
                      border: Border.all(
                        color: AppColors.titleTextColor,
                      ),
                    ...
                    child: Center(
                      child: Text(
                        "+4",
                        style:  TextStyle(
                          color:value==4?AppColors.backgroundColor: AppColors.blackColor,
                          fontWeight: FontWeight.w600,
                        ),
                      ),
                    ),
                  ...
                  child: Container(
                    ...
                    margin: const EdgeInsets.only(right: 10,bottom: 10,top: 10),
                    decoration: BoxDecoration(
                      color:value==5? AppColors.blueColor:AppColors.backgroundColor,
                      borderRadius: BorderRadius.circular(10),
                      border: Border.all(
                        color: AppColors.titleTextColor,
                      ),
                    ...
                    child: Center(
                      child: Text(
                        "+5",
                        style:  TextStyle(
                          color:value==5?AppColors.backgroundColor: AppColors.blackColor,
                          fontWeight: FontWeight.w600,
                        ),
                      ),
                    ),
